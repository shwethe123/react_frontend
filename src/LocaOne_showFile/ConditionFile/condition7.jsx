...
export default function Condition7() {
  ...
  const [selectedCondition, setSelectedCondition] = useState("အလုပ်ထွက်မည့်သူ"); // Change this as needed
  ...
  return (
    <div>
        <div className="flex flex-col bg-gray-400 border-l-4 border-black mt-2 p-1 rounded-md">
        <p className='mb-2 box-decoration-clone text-xs text-white px-2 font-bold'>အလုပ်ထွက်မည့်သူစာရင်း</p>
            {gOutData.length > 0 ? (
