...
export default function Condition5() {
  ...
  const [selectedCondition, setSelectedCondition] = useState("ခွင့်မဲ့"); // Change this as needed
  ...
  return (
    <div>
        <div className="flex flex-col bg-red-400 border-l-4 border-red-600 mt-2 p-1 rounded-md">
        <p className='mb-2 box-decoration-clone text-xs text-white px-2 font-bold'>ခွင့်မဲ့ပျက်ကွက်</p>
            {gOutData.length > 0 ? (
                gOutData.map((item) => (
