...
export default function Condition2() {
  ...
  const [selectedCondition, setSelectedCondition] = useState("ခွင့်တစ်ပိုင်း"); // Change this as needed
  ...
  return (
    <div>
        <div className="flex flex-col bg-green-200 border-l-4 border-green-600 mt-2 p-2 rounded-md">
