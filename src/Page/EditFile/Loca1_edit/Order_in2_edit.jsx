...
export default function Order_in2_edit() {
    ...
    useEffect(() => {
        if (id) {
            const fetch_api = async () => {
                try {
                    const response = await axios.get(`https://dashboard-yfuz.onrender.com/api/order_in_two/${id}`);
    ...
    const UpdatePost = async (e) => {
        try {
            ...
            let res;
            if (id) {
                res = await axios.patch(`https://dashboard-yfuz.onrender.com/api/order_in_two/${id}`, addPost);
            } else {
                res = await axios.post('https://dashboard-yfuz.onrender.com/api/order_in_two', addPost);
                navigate('/LocaOne');
            };
        } catch (error) {
