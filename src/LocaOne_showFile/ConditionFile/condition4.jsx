...
export default function Condition4() {
  ...
  return (
    <div>
        <div className="flex flex-col bg-green-600 border-l-4 border-black mt-2 p-1 rounded-md">
            <p className='mb-2 box-decoration-clone text-xs text-white font-extrabold'>ခွင့်ရက်ရှည်</p>
            {gOutData.length > 0 ? (
                gOutData.map((item) => (
