                ...
                <Link to={`/CarOrder1/Edit/${car_order._id}`} key={car_order._id}>
                    <p className={`
                        rounded-md m-1
                            ...
                            ${car_order.condition === 'ခွင့်ရက်ရှည်' ? 'bg-green-700 border-spacing-4 border-red-300... text-white' : ''} 
                            ${car_order.condition === 'ခွင့်မဲ့' ? 'bg-red-500 text-white' : ''} 
                            ${car_order.condition === 'ဖိုင်းအပြစ်ပေး' ? 'bg-red-400 border-l-4 border-red-600 ... text-white' : ''}
                            ${car_order.condition === 'အလုပ်ထွက်မည့်သူ' ? 'bg-gray-700 border-l-4 border-black ... text-white' : ''}
                            ${car_order.condition === 'အလုပ်ထွက်သူ' ? 'bg-black text-white' : ''} '} 
